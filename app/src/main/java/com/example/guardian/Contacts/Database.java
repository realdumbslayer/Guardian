...
public class Database extends SQLiteOpenHelper {
        ...
        public void addcontact(Template contact){
        ...
        public List<Template> getAllContacts(){
            ...
            if(c.moveToFirst()) {
                do {
                    ...
                    list.add(new Template(c.getInt(0),c.getString(1),c.getString(2)));
        ...
        public void deleteContact(Template contact) {
            SQLiteDatabase db = this.getWritableDatabase();
