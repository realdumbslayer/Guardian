...
public class Sensor extends Service {
        ...
        private Detector mShakeDetector;
        ...
        public void onCreate() {
            ...
            // com.example.nav.ShakeServices.ShakeDetector initialization
            mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
            mAccelerometer = mSensorManager.getDefaultSensor(android.hardware.Sensor.TYPE_ACCELEROMETER);
            mShakeDetector = new Detector();
            mShakeDetector.setOnShakeListener(new Detector.OnShakeListener() {
                        ...
                        fusedLocationClient.getCurrentLocation(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, new CancellationToken() {
                            ...
                            public void onSuccess(Location location) {
                                ...
                                if (location != null) {
                                    ...
                                    Database db = new Database(Sensor.this);
                                    List<Template> list = db.getAllContacts();

                                    // send SMS to each contact
                                    for (Template c : list) {
                                        String message = "Hey, " + c.getName() + " ! I'm in DANGER, I need help. Please reach me out. Here are my coordinates.\n " + "http://maps.google.com/?q=" + location.getLatitude() + "," + location.getLongitude();
                                        smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                    }
                                } else {
                                    String message = "I'm in DANGER, I need help. Please reach me out.\n" + "GPS was turned off. Couldn't find location. Call your nearest Police Station.";
                                    SmsManager smsManager = SmsManager.getDefault();
                                    Database db = new Database(Sensor.this);
                                    List<Template> list = db.getAllContacts();
                                    for (Template c : list) {
        ...
        public void onDestroy() {
            ...
            broadcastIntent.setClass(this, Reactivate.class);
